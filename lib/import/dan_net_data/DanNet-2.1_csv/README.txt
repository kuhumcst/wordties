...
imported as suggested below):
  ex. 1 "All synsets linked to the wordform 'spand'":
     ...
     WHERE s.id = ws.synset_id
       ...
       AND ww.form = 'spand';
    Outputs:
      spand |       |  2928 | Ã¥ben, keglestub- el. cylinderformet ... | Container+Artifact+Object |
      spand | slang |  2148 | gammel og dÃ¥rlig bil                    | Vehicle+Object+Artifact   |
      spand |       |  5697 | gruppe af trÃ¦kdyr spÃ¦ndt for en vogn... | Animal+Object+Group       |
      ...
