...
.toPath('../../import/pwn_data/common_data/1k_final/FinnDannValidation_final_import_ext_syn_2.tsv', 
  {delimiter: '\t', 
   columns: ['pwn_key', 'syn_set_id_2', 'syn_set_id_1', 'label_1', 'rel_1', 'gloss_1']
   })
.transform(function(data) {
   data['label_1'] = data['label_1'].replace(/[,{}_0-9]+/g, '');
   return data;
})
